...
results(5) = EXTENDS_TYPE_OF(p1,s)
...
integer results(7)
integer expect(7)
type(square),allocatable :: s
type(rectangle),allocatable :: r

data expect  /.true.,.false.,.true.,.false.,.false.,.true.,.false./
data results /.false.,.true.,.false.,.true.,.true.,.false.,.true./
