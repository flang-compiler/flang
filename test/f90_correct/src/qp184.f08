...
program test
  ...
  if(s(1) == "   0.123456789123456789123456789123456784E+18") result(1) = 1
  if(s(2) == "   0.123456789123456789123456789123456784E+36") result(2) = 1
  if(s(3) == "   0.123456789123456789123456789123456784E+00") result(3) = 1
  if(s(4) == "   0.123456789123456789123456789123456796E-16") result(4) = 1
  if(s(5) == "   0.123456789123456789123456789123456798E+01") result(5) = 1
  if(s(6) == "   0.123456789123456789123456789123456795E+10") result(6) = 1
  if(s(7) == "  -0.123456789123456789123456789123456784+100") result(7) = 1
  if(s(8) == "*********************************************") result(8) = 1
  if(s(9) == "*********************************************") result(9) = 1
  if(s(10) == "   0.123456789123456789123456789123456789E-02") result(10) = 1
  if(s(11) == "  -0.123456789123456789123456789123456789E-32") result(11) = 1
  if(s(12) == "   0.123456789123456789123456789123456800-332") result(12) = 1
  if(s(13) == "*********************************************") result(13) = 1
  if(s(14) == "*********************************************") result(14) = 1
  if(s(15) == "*********************************************") result(15) = 1
  if(s(16) == "   0.192592994438723585305597794258492732E-33") result(16) = 1
  if(s(17) == "   0.000000000000000000000000000000000000E+00") result(17) = 1
  if(s(18) == "  -0.000000000000000000000000000000000000E+00") result(18) = 1
