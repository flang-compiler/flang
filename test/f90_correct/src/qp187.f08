...
program test
  ...
  if(s(1) == "       123.4567891234567891234567891235E+00015") result(1) = 1
  if(s(2) == "       123.4567891234567891234567891235E+00033") result(2) = 1
  if(s(3) == "       123.4567891234567891234567891235E-00003") result(3) = 1
  if(s(4) == "        12.3456789123456789123456789123E-00018") result(4) = 1
  if(s(5) == "         1.2345678912345678912345678912E+00000") result(5) = 1
  if(s(6) == "         1.2345678912345678912345678912E+00009") result(6) = 1
  if(s(7) == "        -1.2345678912345678912345678912E+00099") result(7) = 1
  if(s(8) == "         1.2345678912345678912345678912E+00999") result(8) = 1
  if(s(9) == "       -12.3456789123456789123456789123E+04320") result(9) = 1
  if(s(10) == "         1.2345678912345678912345678912E-00003") result(10) = 1
  if(s(11) == "        -1.2345678912345678912345678912E-00033") result(11) = 1
  if(s(12) == "         1.2345678912345678912345678912E-00333") result(12) = 1
  if(s(13) == "        -1.2345678912345678912345678912E-03333") result(13) = 1
  if(s(14) == "         1.1897314953572317650857593266E+04932") result(14) = 1
  if(s(15) == "        -3.3621031431120935062626778173E-04932") result(15) = 1
  if(s(16) == "       192.5929944387235853055977942585E-00036") result(16) = 1
  if(s(17) == "         0.0000000000000000000000000000E+00000") result(17) = 1
  if(s(18) == "        -0.0000000000000000000000000000E+00000") result(18) = 1
  if(s(19) == "                                      Infinity") result(19) = 1
  if(s(20) == "                                     -Infinity") result(20) = 1
  if(s(21) == "                                           NaN") result(21) = 1
  if(s(22) == "                                           NaN") result(22) = 1
  100 FORMAT('', EN46.28E5)
