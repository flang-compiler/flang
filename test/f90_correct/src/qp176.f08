...
program test
  ...
  if(s(1) == "***********************************") result(1) = 1
  if(s(2) == "***********************************") result(2) = 1
  if(s(3) == "     0.0123456789123456789123456789") result(3) = 1
  if(s(4) == "     0.0000000000000000012345678912") result(4) = 1
  if(s(5) == "     0.1234567891234567891234567891") result(5) = 1
  if(s(6) == "***********************************") result(6) = 1
  if(s(7) == "***********************************") result(7) = 1
  if(s(8) == "***********************************") result(8) = 1
  if(s(9) == "***********************************") result(9) = 1
  if(s(10) == "     0.0001234567891234567891234568") result(10) = 1
  if(s(11) == "    -0.0000000000000000000000000000") result(11) = 1
  if(s(12) == "     0.0000000000000000000000000000") result(12) = 1
  if(s(13) == "    -0.0000000000000000000000000000") result(13) = 1
  if(s(14) == "***********************************") result(14) = 1
  if(s(15) == "    -0.0000000000000000000000000000") result(15) = 1
  if(s(16) == "     0.0000000000000000000000000000") result(16) = 1
  if(s(17) == "     0.0000000000000000000000000000") result(17) = 1
  if(s(18) == "    -0.0000000000000000000000000000") result(18) = 1
