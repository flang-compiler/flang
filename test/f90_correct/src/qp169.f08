...
program test
  ...
  if(s(1) == "          0.1234567891234567891234567891E+0018") result(1) = 1
  if(s(2) == "          0.1234567891234567891234567891E+0036") result(2) = 1
  if(s(3) == "          0.1234567891234567891234567891E+0000") result(3) = 1
  if(s(4) == "          0.1234567891234567891234567891E-0016") result(4) = 1
  if(s(5) == "          0.1234567891234567891234567891E+0001") result(5) = 1
  if(s(6) == "          0.1234567891234567891234567891E+0010") result(6) = 1
