...
program p
  ...
  if (size(cmp1) /= size((/ ((/ 5, 10, gen (i) /), i = 1, 3) /))) STOP 1
  if (any(shape(cmp1) /= shape((/ ((/ 5, 10, gen (i) /), i = 1, 3) /)))) STOP 2
  if (any(lbound(cmp1) /= lbound((/ ((/ 5, 10, gen (i) /), i = 1, 3) /)))) &
    STOP 3
  if (any(ubound(cmp1) /= ubound((/ ((/ 5, 10, gen (i) /), i = 1, 3) /)))) &
    STOP 4
  if (any(cmp1 /= (/ ((/ 5, 10, gen (i) /), i = 1, 3) /))) STOP 5

  if (size(cmp2) /= size((/ ((/ 5, 10, gen2 (i) /), i = 1, 3) /))) STOP 6
  ...
  if (any(ubound(cmp2) /= ubound((/ ((/ 5, 10, gen2 (i) /), i = 1, 3) /)))) &
    STOP 9
  if (any(cmp2 /= (/ ((/ 5, 10, gen2 (i) /), i = 1, 3) /))) STOP 10

  if (size(cmp3) /= size((/((3, 4, gen3(i, j), i = 1, 2), j = 1, 2)/))) STOP 11
  if (any(shape(cmp3) /= shape((/((3, 4, gen3(i, j), i = 1, 2), j = 1, 2)/)))) STOP 12
  if (any(lbound(cmp3) /= lbound((/((3, 4, gen3(i, j), i = 1, 2), j = 1, 2)/)))) STOP 13
  if (any(ubound(cmp3) /= ubound((/((3, 4, gen3(i, j), i = 1, 2), j = 1, 2)/)))) STOP 14
  if (any(cmp3 /= (/((3, 4, gen3(i, j), i = 1, 2), j = 1, 2)/))) STOP 15
