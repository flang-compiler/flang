...
program test
  ...
  if(s(1) == " 1.2345678912345678912345678912E+17") result(1) = 1
  if(s(2) == " 1.2345678912345678912345678912E+35") result(2) = 1
  if(s(3) == " 1.2345678912345678912345678912E-01") result(3) = 1
  if(s(4) == " 1.2345678912345678912345678912E-17") result(4) = 1
  ...
  if(s(14) == "***********************************") result(14) = 1
  if(s(15) == "***********************************") result(15) = 1
  if(s(16) == " 1.9259299443872358530559779426E-34") result(16) = 1
