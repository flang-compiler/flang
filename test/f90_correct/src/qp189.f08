...
program test
  ...
  if(s(4) == "         12.3456789123456789123456789124E-0018") result(4) = 1
  if(s(5) == "          1.2345678912345678912345678913E+0000") result(5) = 1
  if(s(6) == "          1.2345678912345678912345678913E+0009") result(6) = 1
  if(s(7) == "         -1.2345678912345678912345678912E+0099") result(7) = 1
  if(s(8) == "          1.2345678912345678912345678913E+0999") result(8) = 1
  if(s(9) == "        -12.3456789123456789123456789123E+4320") result(9) = 1
  if(s(10) == "          1.2345678912345678912345678913E-0003") result(10) = 1
  if(s(11) == "         -1.2345678912345678912345678912E-0033") result(11) = 1
  if(s(12) == "          1.2345678912345678912345678913E-0333") result(12) = 1
  if(s(13) == "         -1.2345678912345678912345678912E-3333") result(13) = 1
  if(s(14) == "          1.1897314953572317650857593267E+4932") result(14) = 1
