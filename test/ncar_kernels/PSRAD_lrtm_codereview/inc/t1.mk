...
#  Intel default flags
#
#    FC_FLAGS := -O3 -xAVX -ftz -funroll-loops  -ip -no-fp-port -fp-model fast 
#    -no-prec-div -no-prec-sqrt -override-limits -align array64byte 
#    -DCPRINTEL -mkl 
#    FC_FLAGS := -O3 -xHost
#
...
mo_taumol03.o: $(SRC_DIR)/mo_taumol03.f90 mo_kind.o mo_lrtm_setup.o mo_lrtm_kgs.o
	${FC} ${FC_FLAGS} -c -o $@ $<

mo_taumol04.o: $(SRC_DIR)/mo_taumol04.f90 mo_kind.o mo_lrtm_setup.o mo_lrtm_kgs.o
	${FC} ${FC_FLAGS} -c -o $@ $<

mo_rrlw_planck.o: $(SRC_DIR)/mo_rrlw_planck.f90 
	${FC} ${FC_FLAGS} -c -o  $@ $<
...
mo_lrtm_driver.o: $(SRC_DIR)/mo_lrtm_driver.f90 mo_rrtm_params.o mo_kind.o mo_spec_sampling.o mo_radiation_parameters.o mo_lrtm_setup.o mo_cld_sampling.o mo_rrtm_coeffs.o mo_lrtm_gas_optics.o mo_taumol03.o mo_taumol04.o mo_lrtm_kgs.o mo_physical_constants.o mo_lrtm_solver.o
	${FC} ${FC_FLAGS} -c -o $@ $<
