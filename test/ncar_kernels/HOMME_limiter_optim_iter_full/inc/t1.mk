...
kernel_driver.o: $(SRC_DIR)/kernel_driver.f90 prim_advection_mod.o dimensions_mod.o kinds.o
	${FC} ${FC_FLAGS} -c -o $@ $<

prim_advection_mod.o: $(SRC_DIR)/prim_advection_mod.F90 kinds.o dimensions_mod.o
	${FC} ${FC_FLAGS} -c -o $@ $<
