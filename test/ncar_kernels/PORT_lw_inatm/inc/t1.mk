...
kernel_driver.o: $(SRC_DIR)/kernel_driver.f90 rrtmg_lw_rad.o kgen_utils.o parrrtm.o shr_kind_mod.o rrlw_wvn.o rrlw_con.o
	${FC} ${FC_FLAGS} -c -o $@ $<

rrtmg_lw_rad.o: $(SRC_DIR)/rrtmg_lw_rad.f90 kgen_utils.o shr_kind_mod.o rrlw_con.o parrrtm.o rrlw_wvn.o
	${FC} ${FC_FLAGS} -c -o $@ $<
...
rrlw_wvn.o: $(SRC_DIR)/rrlw_wvn.f90 kgen_utils.o parrrtm.o
	${FC} ${FC_FLAGS} -c -o $@ $<
