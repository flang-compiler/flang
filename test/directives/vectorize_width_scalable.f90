...
! Check that the vectorize_width(scalable) directive generates the correct metadata.
!
...
! CHECK-00:      !"llvm.loop.vectorize.scalable.enable", i1 true
