...
MTHINTRIN(asin , ss   , avx512knl  , __mth_i_asin          , __mth_i_asin          , __mth_i_asin          ,__math_dispatch_error)
MTHINTRIN(asin , ds   , avx512knl  , __mth_i_dasin         , __mth_i_dasin         , __mth_i_dasin         ,__math_dispatch_error)
MTHINTRIN(asin , sv4  , avx512knl  , __fvs_asin            , __fvs_asin            , __gs_asin_4_p         ,__math_dispatch_error)
...
MTHINTRIN(asin , ss   , avx512     , __mth_i_asin          , __mth_i_asin          , __mth_i_asin          ,__math_dispatch_error)
MTHINTRIN(asin , ds   , avx512     , __mth_i_dasin         , __mth_i_dasin         , __mth_i_dasin         ,__math_dispatch_error)
MTHINTRIN(asin , sv4  , avx512     , __fvs_asin            , __fvs_asin            , __gs_asin_4_p         ,__math_dispatch_error)
