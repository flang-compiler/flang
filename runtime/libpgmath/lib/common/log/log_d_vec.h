...
vdouble __log_d_kernel(vdouble m, vdouble e)
{
    ...
    t = vfma_vd_vd_vd_vd(t, m2, m);
    t = vfma_vd_vd_vd_vd(e, *(vdouble*)LOG_2, t);
...
log_d_vec(vdouble const a_input)
{
    vdouble m, e, t;
    ...
    if (__builtin_expect(!vtestz_i_vo(o), 0)) {
        ...
        vdouble den_out = __log_d_kernel(m, e);
