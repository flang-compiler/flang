...
/* mmreal16.c -- F90 fast-/dgemm-like MATMUL intrinsics for real*16 type */
...

{
  ...
  */
  ...
  int i, ja, j, k;
  int astrt = 0;
  int bstrt, cstrt, andx, bndx, cndx, indx, indx_strt;
  /*
  ...
  if ((ta == 0) && (mra == 1) && (ldc == 1)) {
    ...
    ftn_vmmul_real16_(&tb, &ncb, &kab, alpha, a, b, &ldb, beta, c);
    return;
  }
  ...
  if ((colsb <= SMALL_COLSB) && (rowsa <= SMALL_ROWSA) &&
    ...
    switch (tindex) {
    case 0:
      ftn_mnaxnb_real16_(&mra, &ncb, &kab, alpha, a, &lda, b, &ldb, beta, c,
                          &ldc);
      break;
    case 1:
      ftn_mtaxnb_real16_(&mra, &ncb, &kab, alpha, a, &lda, b, &ldb, beta, c,
                          &ldc);
      break;
    case 2:
      ftn_mnaxtb_real16_(&mra, &ncb, &kab, alpha, a, &lda, b, &ldb, beta, c,
                          &ldc);
      break;
    case 3:
      ftn_mtaxtb_real16_(&mra, &ncb, &kab, alpha, a, &lda, b, &ldb, beta, c,
                          &ldc);
    }
  }
}
