...
void
__fort_prof_arecv(int cpu, long len, int reqn)
{
}
...
void
__fort_prof_arecv_done(int cpu)
{
}
...
void
__fort_prof_asend(int cpu, long len, int reqn)
{
}
...
void
__fort_prof_asend_done(int cpu)
{
}
...
void
__fort_prof_await_done(int reqn)
{
}
