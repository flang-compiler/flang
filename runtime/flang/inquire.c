...
inquire(__INT_T *unit, char *file_ptr, __INT_T *bitv, __INT_T *iostat,
        ...
        char *round_ptr, int file_siz, int name_siz, int acc_siz,
        int sequential_siz, int direct_siz, int form_siz, int formatted_siz,
        int unformatted_siz, int blank_siz, int position_siz, int action_siz,
        int read_siz, int write0_siz, int readwrite_siz, int delim_siz,
        int pad_siz, int asynchronous_siz, int decimal_siz, int encoding_siz,
