...
typedef unsigned int FLANG_UFLANG_INT64[2];

typedef union {
  FLANG_INT64 wd;        /* canonical msw & lsw view of long long values */
 ...
 *	    none
 */
VOID __utl_i_add64(arg1, arg2, result) FLANG_INT64 arg1, arg2, result;
{
 ...
 */
VOID
__utl_i_sub64(FLANG_INT64 arg1, FLANG_INT64 arg2, FLANG_INT64 result)
{
 ...
 *       integer product.
 */
VOID __utl_i_mul64(arg1, arg2, result) FLANG_INT64 arg1, arg2, result;
{
  LL_SHAPE v1, v2, r;
...
__mth_i_kdiv(long long x, long long y)
{
  ...
  if (MSW(a) == 0 && MSW(b) == 0) {
    ...
    *(unsigned *)&LSW(r) = (unsigned)LSW(a) / (unsigned)LSW(b);
    ...
    FLANG_INT64 arg1, arg2; /* FLANG_INT64 is big endian!! */
    FLANG_INT64 result;
    arg1[1] = LSW(a);
    arg1[0] = MSW(a);
    arg2[1] = LSW(b);
...
__mth_i_ukdiv(unsigned long long x, unsigned long long y)
{
  ...
  if (UMSW(a) == 0 && UMSW(b) == 0) {
    ...
    FLANG_UFLANG_INT64 arg1, arg2; /* FLANG_UFLANG_INT64 is big endian!! */
 ...
 *       integer quotient.
 */
VOID __utl_i_div64(arg1, arg2, result) FLANG_INT64 arg1, arg2, result;
...
static VOID neg64(arg, result) FLANG_INT64 arg, result;
 ...
 */
VOID
__utl_i_udiv64(FLANG_UFLANG_INT64 arg1, FLANG_UFLANG_INT64 arg2, FLANG_UFLANG_INT64 result)
{
  FLANG_INT64 den;          /* denominator used in calculating the
                       * quotient */
  int i;              /* for loop control variable */
...
VOID __utl_i_fix64(float ff, FLANG_INT64 i) /* use prototype to pass as float */
...
float __utl_i_flt64(FLANG_INT64 i) /* use prototype to return as float */
