...
typedef enum {
  ...
  RTE_dev_allocated,
  RTE_dev_auto_alloc,
  RTE_dev_auto_alloc04,
  RTE_dev_auto_dealloc,
  RTE_dev_bind_texture,
  RTE_dev_chksect,
  RTE_dev_common,
  RTE_dev_common_addr,
  RTE_dev_configure_call,
  RTE_dev_copyin,
  RTE_dev_copyin_2d,
  RTE_dev_copyout,
  RTE_dev_copyover,
  RTE_dev_dealloc03,
  RTE_dev_dealloc_mbr03,
  RTE_dev_finalize,
  RTE_dev_launch,
  RTE_dev_mkdesc,
  RTE_dev_mod_alloc03,
  RTE_dev_mod_alloc04,
  RTE_dev_mod_alloc04m,
  RTE_dev_mod_alloc04p,
  RTE_dev_mod_dealloc03,
  RTE_dev_setup_argument,
  RTE_dev_setup_argument_value,
  RTE_dev_sym_copyin_2d,
  RTE_dev_symbol_address,
  RTE_dev_symhandle_copyin,
  RTE_dev_symhandle_copyout,
  RTE_dev_unbind_texture,
  RTE_dfloor,
  RTE_dfloorv,
  RTE_dmodulev,
  RTE_dmodulov,
  ...
  RTE_man_allocated,
  RTE_man_auto_alloc,
  RTE_man_auto_alloc04,
  RTE_man_auto_dealloc,
  RTE_man_copyin,
  RTE_man_copyout,
  RTE_man_copyover,
  RTE_man_dealloc03,
  RTE_man_dealloc_mbr03,
  RTE_man_mod_alloc03,
  RTE_man_mod_alloc04,
  RTE_man_mod_dealloc03,
  RTE_man_symhandle_copyin,
  RTE_man_symhandle_copyout,
  RTE_matmul_cplx16,
  ...
  RTE_pinned_alloc03,
  RTE_pinned_alloc04,
  RTE_pinned_allocated,
  RTE_pinned_dealloc03,
  RTE_poly_asn,
  RTE_present,
  RTE_present_ptr,
  RTE_presentc,
  ...
  RTE_uboundaz8,
  RTE_verify,
  END_OF_PFX_F90, /* HACK needed temporarily for non-Flang targets */
  RTE_all,
  RTE_all_scatterx,
  RTE_alls,
  RTE_any,
  ...
  RTE_unpack,
  RTE_unpackc,
  END_OF_PFX_FTN, /* HACK needed temporarily for non-Flang targets */
  RTE_f90io_aux_init,
  RTE_f90io_backspace,
  RTE_f90io_begin,
  RTE_f90io_byte_read,
