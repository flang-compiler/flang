...
FtnRteRtn ftnRtlRtns[] = {
    ...
    {"dev_alloc04", "", FALSE, ""},
    {"dev_allocated", "", TRUE, ""},
    {"dev_auto_alloc", "", FALSE, ""},
    {"dev_auto_alloc04", "", FALSE, ""},
    {"dev_auto_dealloc", "", TRUE, ""},
    {"dev_bind_texture", "", TRUE, ""},
    {"dev_chksect", "", FALSE, ""},
    {"dev_common", "", FALSE, ""},
    {"dev_common_addr", "", FALSE, ""},
    {"dev_configure_call", "", FALSE, ""},
    {"dev_copyin", "", FALSE, ""},
    {"dev_copyin_2d", "", FALSE, ""},
    {"dev_copyout", "", FALSE, ""},
    {"dev_copyover", "", FALSE, ""},
    {"dev_dealloc03", "", TRUE, ""},
    {"dev_dealloc_mbr03", "", TRUE, ""},
    {"dev_finalize", "", TRUE, ""},
    {"dev_launch", "", FALSE, ""},
    {"dev_mkdesc", "", FALSE, ""},
    {"dev_mod_alloc03", "", FALSE, ""},
    {"dev_mod_alloc04", "", FALSE, ""},
    {"dev_mod_alloc04m", "", FALSE, ""},
    {"dev_mod_alloc04p", "", FALSE, ""},
    {"dev_mod_dealloc03", "", TRUE, ""},
    {"dev_setup_argument", "", FALSE, ""},
    {"dev_setup_argument_value", "", FALSE, ""},
    {"dev_sym_copyin_2d", "", FALSE, ""},
    {"dev_symbol_address", "", FALSE, ""},
    {"dev_symhandle_copyin", "", FALSE, ""},
    {"dev_symhandle_copyout", "", FALSE, ""},
    {"dev_unbind_texture", "", TRUE, ""},
    {"dfloor", "", FALSE, "k"},
    {"dfloorv", "", FALSE, "k"},
    {"dmodulev", "", FALSE, ""},
    {"dmodulov", "", FALSE, ""},
    ...
    {"man_alloc04", "", FALSE, ""},
    {"man_allocated", "", TRUE, ""},
    {"man_auto_alloc", "", FALSE, ""},
    {"man_auto_alloc04", "", FALSE, ""},
    {"man_auto_dealloc", "", TRUE, ""},
    {"man_copyin", "", FALSE, ""},
    {"man_copyout", "", FALSE, ""},
    {"man_copyover", "", FALSE, ""},
    {"man_dealloc03", "", TRUE, ""},
    {"man_dealloc_mbr03", "", TRUE, ""},
    {"man_mod_alloc03", "", FALSE, ""},
    {"man_mod_alloc04", "", FALSE, ""},
    {"man_mod_dealloc03", "", TRUE, ""},
    {"man_symhandle_copyin", "", FALSE, ""},
    {"man_symhandle_copyout", "", FALSE, ""},
    {"matmul_cplx16", "", TRUE, ""},
    ...
    {"nverify", "", FALSE, "k"},
    {"pause", "", FALSE, ""},
    {"pinned_alloc03", "", FALSE, ""},
    {"pinned_alloc04", "", FALSE, ""},
    {"pinned_allocated", "", TRUE, ""},
    {"pinned_dealloc03", "", TRUE, ""},
    {"poly_asn", "", TRUE, ""},
    {"present", "", FALSE, "k"},
    {"present_ptr", "", FALSE, "k"},
    {"presentc", "", FALSE, "k"},
    ...
    {"anys", "", FALSE, ""},
    {"associated", "", FALSE, ""},
    {"associated_char", "", FALSE, ""},
    {"associated_t", "", FALSE, ""},
    {"associated_tchar", "", FALSE, ""},
    {"barrier", "", FALSE, ""},
    {"block_loop", "", FALSE, ""},
    {"comm_copy", "", FALSE, ""},
    {"comm_free", "", FALSE, ""},
