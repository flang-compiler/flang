...
#define NEWDSCG(s)   (( stb.s_base)[s].w10)
#define NEWDSCP(s,v) (( stb.s_base)[s].w10 = (v))
#define ARGINFOG(s)   (( stb.s_base)[s].w16)
#define ARGINFOP(s,v) (( stb.s_base)[s].w16 = (v))
...
char *mk_coercion_func_name(int);
...
char *mangle_name(char *, char *);
char *sym_strsave(char *);
