...
#undef iscsym
#define iscsym(c) (ctable[(int)c] & _CS)
#undef isblank
#define isblank(c) (ctable[(int)c] & _BL)
#undef iswhite
#define iswhite(c) ((c) <= ' ')
#define ishex(c) (ctable[(int)c] & (_HD | _DI))
#define isident(c) (ctable[(int)c] & (_CS | _DI))
#define isdig(c) (ctable[(int)c] & _DI)
#define isodigit(c) ((c) >= '0' && (c) <= '7')
#define isholl(c) (ctable[(int)c] & _HO)
